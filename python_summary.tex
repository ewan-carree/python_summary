...
MyClass = type("MyClass", (object,), {'x': 5, 'y': 10, "my_method": my_method}) #don't froget the coma after object
...
We can see that our metaclass inherits from \textbf{type} and not \textbf{object} as usual. It overwrites de \_\_new\_\_() method with our own method. We can also see that our class use our metaclass by defining in argument : \textbf{metaclass = Meta}.
